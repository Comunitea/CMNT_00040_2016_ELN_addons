...
class action_traceability(osv.osv_memory):
    ...
    def action_traceability(self, cr, uid, ids, context=None):
        ...
        cr.execute("""select valid_stock_moves.id from valid_stock_moves inner join stock_production_lot
            on valid_stock_moves.prodlot_id = stock_production_lot.id where valid_stock_moves.id in %s
            and valid_stock_moves.location_id != valid_stock_moves.location_dest_id and
