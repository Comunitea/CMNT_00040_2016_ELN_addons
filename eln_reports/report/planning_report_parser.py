...
report_sxw.report_sxw('report.planning_report_webkit', 'planning.report.wizard', 'eln_reports/report/planning_report_webkit.mako', parser=planning_report_parser, header=False)
