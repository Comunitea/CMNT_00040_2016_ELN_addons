...
class product_product(orm.Model):
    ...
    _columns = {
        ...
        'pallet_gross_weight': fields.float('Gross weight (kg)', digits=(16,2)),
        'pallet_net_weight': fields.float('Net weight (kg)', digits=(16,2)),
        ...
        'box_gross_weight': fields.float('Gross weight (kg)', digits=(16,2)),
        'box_net_weight': fields.float('Net weight (kg)', digits=(16,2)),
        ...
        'unit_gross_weight': fields.float('Gross weight (g)', digits=(16,0)),
        'unit_net_weight': fields.float('Net weight (g)', digits=(16,0)),
        'unit_net_weight_drained': fields.float('Net Drained Weight (g)', digits=(16,0), help="The drained net weight in g. Leave zero if not applicable."),
