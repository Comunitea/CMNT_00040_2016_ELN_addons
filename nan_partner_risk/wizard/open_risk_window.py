...
class open_risk_window(osv.osv_memory):
    ...
    _defaults = {
        ...
        'circulating_amount': lambda self, cr, uid, context: self.pool.get('res.partner').browse(cr, uid, context['risk_partner_id'], context).circulating_amount or 0.0,
    ...
    def default_get(self, cr, uid, fields, context=None):
        ...
        res = super(open_risk_window, self).default_get(cr, uid, fields, context=context)
        return res
