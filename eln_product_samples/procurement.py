...
# POST-MIGRATION:
# Se sustituye por regla de stock que imite el comportamiento
# de crear un albarán de stock a existencias para abastecer los
# movimientos que en el action_ship_create se les marcó la ubicación
# de origen de muestras
